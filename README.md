...
usage: birds.py [-h] [--angle ANGLE] [-v V] [--width WIDTH] [--height HEIGHT]
                [--n N] [--eta ETA] [--radius RADIUS] [--export]
...
optional arguments:
  ...
  -v V                  Velocity, default=3.0
  --width WIDTH         Range for x-coordinate, default=500
  --height HEIGHT       Range for y-coordinate, default=500
  --n N, -n N           Number of boids, default=100
  --eta ETA             Generates Angles -eta/2 < delta Theta < eta/2,
                        default=0
  --radius RADIUS, -r RADIUS
                        Viewing Radius, default=100
