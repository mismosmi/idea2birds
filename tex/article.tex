...
We have compared the collective motion of birds to a thermodynamic phase transition. The connection between these is not obvious. However we see simlilarities in how increasing the randomness\todo[inline]{temperature?} will distrupt alignment and how denser systems will display longer effective interaction range.

The addition of a cone-like vision is, as the name suggests, inspired from birds rather than thermodynamics. To our knowledge it doesn't have an equivalent in this field\todo[inline]{does it?}, \todo[inline]{however it might tell us something about directional interaction}
