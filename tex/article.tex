...
\end{equation}
% Note: here you had a sentence about eta->0 for an unordered and eta->1 for an
% ordered state, this is already explained in more detail in the results and,
% i guess, makes more sense there.
...
determine $\beta$ from equation~\eqref{eq:va-eta} to be \todo{get value of $\beta$} \todo{What do we use $\beta$ for?}. 
...
transition. However we see simlilarities in how increasing the randomness\todo{temperature?} will distrupt alignment and how more dense systems will display longer effective interaction range.
